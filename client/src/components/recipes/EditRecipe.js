...
const EditRecipe = ({
	...
	const [isEditMode, setisEditMode] = useState(initialValue);
	...
	const submitChanges = e => {
		...
		if (name === "ingr") {
			setrecipeValue({
				...recipeValue,
				ingr:
					typeof recipeValuerecipe === "string"
						? recipeValue.ingr.split(",")
						: recipeValue.ingr
			});
		}
		setFinishEditing({ ...isFinishEditing, [name]: true });
		...
		return (
			<div className="recipe">
				...
				<div className="recipe__title">
					{!isEditMode.title && (
						<button
							onClick={() => setisEditMode({ ...isEditMode, title: true })}
						>
							Edit
						</button>
					)}
				...
				<div className="recipe__prep">
					...
					{!isEditMode.prep && (
						<button
							onClick={() => setisEditMode({ ...isEditMode, prep: true })}
						>
							Edit
						</button>
					)}
				...
				<div className="recipe__ingredients">
					{!isEditMode.ingr && (
						<button
							onClick={() => setisEditMode({ ...isEditMode, ingr: true })}
						>
							Edit
						</button>
					)}
